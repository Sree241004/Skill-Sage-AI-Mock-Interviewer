...
function AddNewInterview() {
  ...
  const onSubmit = async (e) => {
    ...
    const inputPrompt = `Job position: ${jobPosition}, Job Description: ${jobDescription}, Years of Experience: ${jobExperience}. Based on Job Position, Job Description and Years of Experience give us ${process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT} Interview questions along with Answers in JSON format. Provide the response strictly as an array of JSON objects, where each object has "question" and "answer" fields. Example:
  [
    {
