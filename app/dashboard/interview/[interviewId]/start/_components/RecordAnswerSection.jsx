...
const RecordAnswerSection = ({
  ...
  const UpdateUserAnswer = async () => {
    ...
    const feedbackPrompt =
      ...
      ", User Answer:" +
      userAnswer +
      ". Based on the question and user answer, please provide a rating (number) and feedback for area of improvement (if any) in just 3 to 5 lines. Ensure the response is strictly in valid JSON format with a 'rating' field and a 'feedback' field.";
    console.log(
